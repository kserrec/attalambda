...
try {
    ...
    $nameMatch = [regex]::Match($archiveName, '^attalambda-(0[.]2[.]0(?:-dev|-rc[.]1)?|0[.]3[.]0(?:-dev)?|0[.]4[.]0|0[.]5[.]0)-windows-x86_64[.]zip$', [Text.RegularExpressions.RegexOptions]::CultureInvariant)
